...
CREATE TABLE `product details` (
  ...
  `Width` double(2,2) DEFAULT NULL,
  `Height` double(2,2) DEFAULT NULL,
  `Colour` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`Product_ID`),
  CONSTRAINT `has details` FOREIGN KEY (`Product_ID`) REFERENCES `product` (`Product_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
